...
public class Quizfrage {
	...
	/**
	 * Gibt NACH dem beenden der Frage die Dauer zuräck. Wenn begin oder ende
	 * noch nicht gesezt sind, gibt die Funktion -1 zuräck.
	 * 
	 ...
	 * Zeitpunkt zuräck Wenn begin noch nicht gesetzt ist, gibt die Funktion -1
	 * zuräck.
	 * 
	 * @return long zeitDifferenz
	 */
