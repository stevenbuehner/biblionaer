...
public class Spiel {
	...
	/**
	 * Gibt NACH dem beenden des Spiels die Dauer zurück. Wenn spielbeginn oder
	 * spielende noch nicht gesezt sind, gibt die Funktion -1 zurück.
	 * 
	 ...
	 * aktuellen Zeitpunkt zurück Wenn spielgbein noch nicht gesetzt ist, gibt
	...
	public boolean istAktuelleAntwort(int antwortNummer) {
		...
		if ( fragen.length < aktuelleFrage ) {
			Biblionaer.meineKonsole
					.println(
							"Spiel.istAktuelleAntwort kann nicht ausgeführt werden, Indizierungsfehler. Angefordert wurde die ID: "
									+ this.aktuelleFrage, 1 );
			return false;
		}
	...
	public int getAktuelleRichtigeAntwort() {
		if ( fragen.length < aktuelleFrage ) {
			Biblionaer.meineKonsole
					.println(
							"Spiel.getAktuelleRichtigeAntwort kann nicht ausgeführt werden, Indizierungsfehler. Angefordert wurde die ID: "
									+ this.aktuelleFrage, 1 );
			return -1;
		}
	...
	public void aktuelleFrageBeantwortet() {
		if ( fragen.length < aktuelleFrage ) {
			Biblionaer.meineKonsole
					.println(
							"Spiel.aktuelleFrageRichtigBeantwortet kann nicht ausgeführt werden, Indizierungsfehler. Angefordert wurde die ID: "
									+ this.aktuelleFrage, 1 );
			return;
		}
	...
	/**
	 * Debugging FUnktion ... gibt die übergebene Frage auf der Konsole aus
	 */
