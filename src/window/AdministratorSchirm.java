...
public class AdministratorSchirm extends JFrame implements QuizFenster, BackendWindow, ActionListener, Observer {
	...
	// TODO Ebenen-Beschriftung im PSD ändern
	...
	// TODO Icon skalieren, und im PSD einfügen
	protected ImageIcon starIcon = new ImageIcon("src/img/star.png");

	// TODO Icon für App-Quit suchen/erstellen
	protected ImageIcon appQuitIcon = new ImageIcon("src/img/gameQuit.png");

	// TODO Icon scalikeren und im PSD anpassen
	...
	protected JButton laufendsSpielBeendenBtn = new JButton("<html>Spiel beenden</html>", gameQuitIcon);
	...
	protected JButton spielPausierenBtn = new JButton("<html>Spiel pausieren</html>", pauseIcon);
	...
	protected JButton schwarzerBildschirmBtn = new JButton("<html>schwarzer Bildschirm</html>", blackIcon);
	protected JButton einstellungenBtn = new JButton("Einstellungen", settingsIcon);
	protected JButton programmBeenden = new JButton("<html>Programm beenden</html>", appQuitIcon);
	...
	private void doInitialisations() {
		...
		addComponent(quizSteuerungPanel, gbl_quizSteuerung, fragestellungPanel, 0, 1, 2, 1, 1.0, 1.0, new Insets(20, 5,
				20, 5));
		...
		addComponent(quizSteuerungPanel, gbl_quizSteuerung, antwort1Panel, 0, 2, 1, 1, 0.1, 0.2, new Insets(2, 5, 2, 2));

		this.antwort2Panel = new JPanel(new GridLayout(1, 0));
		this.antwort2Panel.add(this.antwort2KlickenBtn);
		addComponent(quizSteuerungPanel, gbl_quizSteuerung, antwort2Panel, 1, 2, 1, 1, 0.1, 0.2, new Insets(2, 2, 2, 5));

		this.antwort3Panel = new JPanel(new GridLayout(1, 0));
		this.antwort3Panel.add(this.antwort3KlickenBtn);
		addComponent(quizSteuerungPanel, gbl_quizSteuerung, antwort3Panel, 0, 3, 1, 1, 0.1, 0.2, new Insets(2, 5, 2, 2));

		this.antwort4Panel = new JPanel(new GridLayout(1, 0));
		this.antwort4Panel.add(this.antwort4KlickenBtn);
		addComponent(quizSteuerungPanel, gbl_quizSteuerung, antwort4Panel, 1, 3, 1, 1, 0.1, 0.2, new Insets(2, 2, 2, 5));

		addComponent(quizSteuerungPanel, gbl_quizSteuerung, new JLabel("Bibelstelle (Tipp-Joker): "), 0, 4, 1, 1, 0, 0,
				new Insets(5, 5, 5, 5));
		addComponent(quizSteuerungPanel, gbl_quizSteuerung, bibelstelleLabel, 1, 4, 1, 1, 0, 0.0,
				new Insets(5, 0, 5, 5));
		...
		rowSM.addListSelectionListener(new ListSelectionListener() {
			...
			public void valueChanged(ListSelectionEvent e) {
				...
				if (((QuizFileModel) AdministratorSchirm.this.spielListeTable.getModel()).isRowDeletable(selectedIndex)) {
		...
		addComponent(this.dateiPanel, gbl_dateiPanel, this.angeklicktesSpielStartenBtn, 2, 1, 1, 1, 0, 0, new Insets(0,
				2, 2, 2));
		addComponent(this.dateiPanel, gbl_dateiPanel, this.angeklickesSpielLoeschenBtn, 2, 2, 1, 1, 0, 0, new Insets(0,
				2, 2, 2));
		...
		addComponent(screenControlePanel, gbl, this.schwarzerBildschirmBtn, 2, 1, 2, 1, 0, 0.2, new Insets(0, 5, 1, 5));
		addComponent(screenControlePanel, gbl, this.spielPausierenBtn, 2, 2, 2, 1, 0, 0.2, new Insets(1, 5, 1, 5));
		addComponent(screenControlePanel, gbl, this.laufendsSpielBeendenBtn, 2, 3, 2, 1, 0, 0.2, new Insets(1, 5, 1, 5));
