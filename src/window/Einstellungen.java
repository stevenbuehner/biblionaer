...
public class Einstellungen extends JFrame implements ActionListener, KeyListener {
			...
			// Admin Fenster auf den ersten Monitor legen. Frontendfenster auf
				...
				if ( GraphicsEnvironment.getLocalGraphicsEnvironment().getScreenDevices().length > 1 ) {
					...
					Biblionaer.meineKonsole
							.println(
									"Es ist nur ein Monitor angeschlossen => Zweimonitorbetrieb nicht mäglich",
									2 );
	...
	protected void init() {
		...
		// Tipp-Joker
		lbl = new JLabel( "Zeit fär den Tipp-Joker (in Sekunden)" );
		quizEinstellungen.add( lbl );
		...
		// Puplikums-Joker
		lbl = new JLabel( "Zeit fär den Puplikums-Joker (in Sekunden)" );
		quizEinstellungen.add( lbl );
		...
		quizPingAnzeigen
				.setToolTipText( "Zeigt die Verzägerung des Computers im rechten oberen Eck des Fensters an. Je kleiner die Zahl, desto besser." );
		...
		/*
		 * Hier fehlt jetzt noch die Räckkopplung ... wenn einer äber die setter
