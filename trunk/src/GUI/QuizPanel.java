...
public abstract class QuizPanel extends Rectangle2D.Double implements Drawable, Movable {
	...
	protected double			endPositionX;				// FŸr Bewegungen
	protected double			endPositionY;				// FŸr Bewegungen
	...
	public QuizPanel(BufferedImage[] i, double x, double y, long delay, Hauptfenster p) {
		pics = i;
		this.x = x;
		this.y = y;
