...
public class VollbildSchirm extends JFrame implements QuizFenster, Runnable, FrontendWindow {
	...
	private void doInitializations() {
		...
		// Zentrieren der Antwortfelder und berechnen der Größen
		...
		initFragekasten( ganzerFragekastenHeight, ganzerFragekastenWidth,
				(screenWidth - ganzerFragekastenWidth) / 2, abstandObenFuerJoker + abstandZuJoker );
		...
		int JokerPosX = (screenWidth - ganzerFragekastenWidth) / 2 + ganzerFragekastenWidth
				- jokerBreite * 3 - jokerAbstandX * 2;
		int JokerPosY = 17;
		fiftyJokerPanel = new QuizPanelJoker( lib.getSprite( "img/fiftyJoker.png", 3, 1 ),
				JokerPosX, JokerPosY );
		tippJokerPanel = new QuizPanelJoker( lib.getSprite( "img/tippJoker.png", 3, 1 ), JokerPosX
				+ jokerBreite + jokerAbstandX, JokerPosY );
		publikumsJoker = new QuizPanelJoker( lib.getSprite( "img/puplikumsJoker.png", 3, 1 ),
				JokerPosX + jokerBreite * 2 + jokerAbstandX * 2, JokerPosY );
	...
	private void initFragekasten(int height, int width, int posX, int posY) {
		...
		frage = new QuizPolygonPanelFrage( posX, posY, width, heightFrageUndSchwGrad,
				antwortKastenHeight, frageKastenHeight, -1 );
		...
		antwort1 = new QuizPolygonPanelAntwort( posX, posY + height - antwortKastenHeight * 2
				- abstandZwischenAntwortenHeight, antwortKastenWidth, antwortKastenHeight, "A: ",
				-1 );

		antwort2 = new QuizPolygonPanelAntwort( posX + antwortKastenWidth
				+ abstandZwischenAntwortenWidth, posY + height - antwortKastenHeight * 2
				- abstandZwischenAntwortenHeight, antwortKastenWidth, antwortKastenHeight, "B: ",
				-1 );

		antwort3 = new QuizPolygonPanelAntwort( posX, posY + height - antwortKastenHeight,
				antwortKastenWidth, antwortKastenHeight, "C: ", -1 );

		antwort4 = new QuizPolygonPanelAntwort( posX + antwortKastenWidth
				+ abstandZwischenAntwortenWidth, posY + height - antwortKastenHeight,
				antwortKastenWidth, antwortKastenHeight, "D: ", -1 );
	...
	// Ab hier die Mehtoden für das QuizFenster
